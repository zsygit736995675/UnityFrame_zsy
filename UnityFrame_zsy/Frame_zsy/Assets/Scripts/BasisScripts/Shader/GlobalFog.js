...
class GlobalFog extends PostEffectsBase {
	...
	public var offsetValue : float = 0.0f;
	...
	function OnRenderImage (source : RenderTexture, destination : RenderTexture) {	
		...
		var topLeft01 : Vector3 =  new Vector3(topLeft.x,topLeft.y,topLeft.z + (offsetValue * 0.6f));
		var topRight01 : Vector3 =  new Vector3(topRight.x,topRight.y,topRight.z + (offsetValue * 0.6f));
		var bottomRight01 : Vector3 =  new Vector3(bottomRight.x,bottomRight.y,bottomRight.z + (offsetValue * 2.0f));
		var bottomLeft01 : Vector3 =  new Vector3(bottomLeft.x,bottomLeft.y,bottomLeft.z + (offsetValue * 2.0f));

		//print(topLeft01);


		frustumCorners.SetRow (0, topLeft01); 
		frustumCorners.SetRow (1, topRight01);		
		frustumCorners.SetRow (2, bottomRight01);
		frustumCorners.SetRow (3, bottomLeft01);		
